...
public class BaseRestAssuredClass {
    ...
    private static String baseuri = "https://happyreturnsqatest.free.beeceptor.com/";
...
public static void setup(){baseuri="https://happyreturnsqatest.free.beeceptor.com/";}
...
return with().baseUri(baseuri).accept(ContentType.JSON).when().get("/getProductVariants").then().
